<?php
$cfg_basehost = 'http://www.gugeplay.com';
$cfg_cmspath = '/index';
$cfg_cookie_encode = '111111';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '唐山职业装[唐山工作服]定做定制网';
$cfg_adminemail = 'cxxp@163.com';
$cfg_html_editor = 'fck';
$cfg_arcdir = '/';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 2002-2009 唐山职业装[唐山工作服]定做定制网. 版权所有 ';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '唐山职业装,唐山工作服,唐山舞蹈服装,唐山职业装,定做工作服,职业装定做,唐山职业装,职业装订做,办公室职业装,职业服饰,职业工作服';
$cfg_description = '唐山职业装网，专门从事职业装、工作服、舞蹈服装等的定做定制，1件起订，款式多样，价格优惠，专业订做男士职业装、女士职业装、夏季职业装、秋冬职业装、休闲职业装、职业服饰、职业工作服等';
$cfg_beian = '京ICP备09113895号';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
